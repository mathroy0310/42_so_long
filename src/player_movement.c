...
/*   Updated: 2023/04/05 17:40:49 by maroy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_up(t_game *g)
{
	if ('1' != g->map[g->player_pos.y -1][g->player_pos.x])
	{
		...
		if ('E' == g->map[g->player_pos.y -1][g->player_pos.x] && g->nbcollect == 0)
			ft_you_win(g);
		g->player_pos.y -= 1;
		g->nbmoves += 1;
...
void	ft_move_right(t_game *g)
{
	if ('1' != g->map[g->player_pos.y][g->player_pos.x + 1])
	{
		...
		if ('E' == g->map[g->player_pos.y][g->player_pos.x +1] && g->nbcollect == 0)
			ft_you_win(g);
		g->player_pos.x += 1;
		g->nbmoves += 1;
				ft_printf("Nombre de Mouvement : <%d> \n", g->nbmoves);
